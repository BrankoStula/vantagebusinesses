...
const flowSteps: WorkflowStep[] = [
  {
    ...
    desc: "We analyze your current workflows to identify single points of failure and hidden valuation leakage.",
    variant: "v1",
  ...
  },
  {
    ...
    desc: "We design a unified, automated data infrastructure tailored precisely to your business model.",
    variant: "v2",
  ...
  },
  {
    num: "03",
    title: "AI Deployment",
    desc: "Manual, founder-reliant processes are replaced with intelligent, highly scalable workflows.",
    variant: "v3",
  ...
  },
  {
    ...
    desc: "Your operations transform into a highly efficient, exit-ready asset commanding a premium multiple.",
    variant: "v4",
